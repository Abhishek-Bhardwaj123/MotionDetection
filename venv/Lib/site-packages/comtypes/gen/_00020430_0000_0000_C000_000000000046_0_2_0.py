...
IFontDisp = Font
__all__ = [ 'OLE_XPOS_PIXELS', 'OLE_COLOR', 'OLE_YPOS_CONTAINER',
           'IFontEventsDisp', 'FONTITALIC', 'OLE_XSIZE_HIMETRIC',
           'FONTSIZE', 'VgaColor', 'OLE_CANCELBOOL', 'IFontDisp',
           'OLE_TRISTATE', 'IPictureDisp', 'Color',
           'LoadPictureConstants', 'Unchecked', 'OLE_XSIZE_CONTAINER',
           'OLE_XPOS_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL', 'FONTBOLD',
           'Monochrome', 'Checked', 'Gray', 'OLE_HANDLE',
           'FontEvents', 'FONTNAME', 'StdFont', 'OLE_XSIZE_PIXELS',
           'OLE_YPOS_HIMETRIC', 'FONTUNDERSCORE', 'FONTSTRIKETHROUGH',
           'OLE_OPTEXCLUSIVE', 'OLE_YSIZE_PIXELS', 'Default',
           'OLE_YSIZE_HIMETRIC', 'OLE_YPOS_PIXELS',
           'OLE_YSIZE_CONTAINER', 'IFont', 'IPicture',
           'OLE_XPOS_CONTAINER', 'StdPicture', 'Font', 'Picture']
